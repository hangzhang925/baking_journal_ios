...
struct StarterView: View {
    ...
    private var weightSection: some View {
        VStack(alignment: .leading, spacing: BakingSpace.sm) {
            ...
            VStack(spacing: BakingSpace.sm) {
                HStack(spacing: BakingSpace.md) {
                    Text(BakingTerms.starterContainerWeight)
        ...
        VStack(alignment: .leading, spacing: BakingSpace.sm) {
            ...
            VStack(spacing: 0) {
                ...
                if store.starterProfile.isReminderEnabled {
                    ...
                    VStack(alignment: .leading, spacing: BakingSpace.sm) {
                        Text(BakingTerms.starterReminderTimes)
                            .font(.caption.weight(.semibold))
                            .foregroundStyle(Color.brandSecondaryText)
    ...
    private func weightField(value: Binding<Double>, field: StarterField, isEnabled: Bool = true) -> some View {
        ...
        .padding(.vertical, BakingSpace.xs)
        .bakingFieldSurface(
            background: isEnabled ? Color.brandBackground.opacity(0.82) : Color.brandBackground.opacity(0.42),
            stroke: isEnabled ? Color.brandPrimary.opacity(0.12) : Color.brandPrimary.opacity(0.06),
            radius: BakingRadius.compactCard
        )
    }
...
private struct StarterFeedInlineMetric: View {
    ...
    var body: some View {
        ...
        .padding(.vertical, BakingSpace.sm)
        .frame(maxWidth: .infinity, alignment: .leading)
        .background(isWater ? Color.waterSurface.opacity(0.42) : Color.brandBackground.opacity(0.68))
        ...
        .overlay {
            RoundedRectangle(cornerRadius: BakingRadius.compactCard, style: .continuous)
                .stroke(isWater ? Color.brandSea.opacity(0.10) : Color.brandPrimary.opacity(0.08), lineWidth: 0.5)
        }
    }
}
